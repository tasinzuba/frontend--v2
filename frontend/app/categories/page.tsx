        ...
        return (
            <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-slate-50 via-white to-slate-100">
                <div className="text-center space-y-6">
                    <div className="w-20 h-20 mx-auto bg-gradient-to-br from-sky-500 to-sky-600 rounded-3xl flex items-center justify-center animate-pulse shadow-lg shadow-sky-500/20">
        ...
        <div className="min-h-screen bg-gradient-to-br from-slate-50 via-white to-slate-100 pt-28 pb-20">
            <div className="max-w-[1400px] mx-auto px-4 md:px-10">
                ...
                <div className="relative mb-20 overflow-hidden">
                    <div className="absolute inset-0 bg-gradient-to-r from-sky-500/5 via-transparent to-sky-500/5 rounded-[60px]"></div>
                    <div className="relative z-10 text-center py-16 px-8">
                        <div className="inline-flex items-center gap-2 px-5 py-2 bg-sky-50 text-sky-600 rounded-full text-[11px] font-bold uppercase tracking-widest mb-6 border border-sky-100">
                            <Sparkles className="w-4 h-4" />
                            Explore Our Collection
                        </div>
                        <h1 className="text-5xl lg:text-7xl font-bold text-slate-900 tracking-tight mb-6">
                            Product <span className="bg-gradient-to-r from-sky-600 to-sky-700 bg-clip-text text-transparent">Categories</span>
                        </h1>
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-8 stagger-children">
                    {categories.map((cat, idx) => (
                        <Link
                            ...
                            className="group relative bg-white rounded-[32px] overflow-hidden border border-slate-100 hover:shadow-2xl hover:shadow-slate-200/50 transition-all duration-700 hover:-translate-y-1"
                        >
                            {/* Image */}
                            ...
                            <div className="p-6">
                                ...
                                <div className="flex items-center justify-between">
                                    ...
                                    <div className="w-10 h-10 bg-slate-900 rounded-xl flex items-center justify-center text-white group-hover:bg-sky-600 transition-all duration-300">
                            ...
                            <div className={`absolute inset-0 rounded-[32px] opacity-0 group-hover:opacity-100 transition-opacity pointer-events-none`} style={{ background: `linear-gradient(to bottom right, transparent 60%, rgba(14, 165, 233, 0.1))` }}></div>
                        </Link>
                    ))}
                </div>
